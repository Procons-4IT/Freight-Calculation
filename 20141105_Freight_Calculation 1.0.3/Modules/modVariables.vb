Public Module modVariables
    ...
    Public frmFBaseType As String = String.Empty
    Public dblSOQuanity As Double = 0
    Public dblBfDisTotal As Double = 0
    Public dblDiscount As Double = 0
    Public blnAutoFreight As Boolean = False
